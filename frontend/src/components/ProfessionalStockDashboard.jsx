        ...
        <main className="w-full px-6 py-8">
          ...
          <div className="mb-4 relative z-[9998]">
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-xl border border-slate-700/50 p-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-4 pt-4 border-t border-slate-700/30">
                {/* Date Range Sliders */}
                  ...
                  <div className="flex items-center gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-[200px]">
                      <input
                        ...
                        className="flex-1 h-2 bg-gradient-to-r from-green-500 to-slate-600 rounded appearance-none cursor-pointer min-w-[80px]"
                      />
                      <input
                        type="range"
                        min="0"
                        ...
                        className="flex-1 h-2 bg-gradient-to-r from-slate-600 to-red-500 rounded appearance-none cursor-pointer min-w-[80px]"
                      />
                    </div>
                    <div className="text-xs text-slate-400 whitespace-nowrap min-w-[120px]">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <label className="text-sm font-medium text-slate-300 whitespace-nowrap">Quick:</label>
                  <div className="flex items-center gap-1">
                    {['1M', '3M', '6M', '1Y'].map(range => (
                      <button
                        key={range}
                        onClick={() => setQuickRange(range)}
                        className="px-3 py-1.5 bg-slate-700/50 hover:bg-blue-500/20 text-slate-300 hover:text-white rounded text-xs transition-all duration-200 min-w-[36px]"
                      >
                        {range}
                      </button>
                    ))}
                    {onLoadAllData && (
                      <button
                        ...
                        className="px-3 py-1.5 bg-orange-500/20 hover:bg-orange-500/30 text-orange-300 hover:text-white rounded text-xs transition-all duration-200"
                      >
                        All
                      </button>
                    )}
